  ...
  return (
    <div className="flex-1 pb-14 bg-[#F8FAFC] min-h-screen text-[#0F172A] font-sans">
      ...
      <div className="mx-auto max-w-7xl px-6 sm:px-10 space-y-5">
        {/* Top 4 Stat Cards matching Skillset layout with refined colors */}
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {/* Card 1: Deep Midnight Slate hero card */}
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 rounded-2xl bg-white p-6 shadow-[0_2px_12px_rgba(15,23,42,0.03)] border border-slate-200/80">
            <div className="flex items-center justify-between mb-6">
              ...
              <Link
                href="/dashboard/fees"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-600 hover:bg-[#2563EB] hover:text-white transition-colors"
              >
                  ...
                  <div key={bar.month} className="flex flex-col items-center gap-3 h-full justify-end">
                    <div className="w-10 sm:w-12 bg-slate-100 rounded-2xl overflow-hidden flex items-end h-44 p-1">
                      <div
                        className={`w-full rounded-xl transition-all duration-500 ${
                          bar.active
                            ? "bg-[#0F172A] shadow-md ring-2 ring-[#2563EB]"
                    ...
                    <span
                      className={`text-xs font-bold ${
                        bar.active ? "text-[#0F172A]" : "text-slate-400"
                      }`}
                    >
                      {bar.month}
                    </span>
        ...
        <div className="rounded-2xl bg-white p-6 shadow-[0_2px_12px_rgba(15,23,42,0.03)] border border-slate-200/80">
          <div className="flex items-center justify-between pb-4 border-b border-slate-100">
            ...
            <div className="flex items-center gap-2">
              <button
                type="button"
                className="flex h-8 w-8 items-center justify-center rounded-full bg-slate-100 text-slate-500 hover:text-slate-800 transition-colors"
                title="Refresh"
              >
